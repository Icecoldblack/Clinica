              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-surface-container-lowest p-5 rounded-lg border-b-2 border-secondary">
                    <p className="text-sm text-on-surface-variant mb-1 font-label uppercase tracking-tighter">Status</p>
            ...
            <div>
              ...
              <div className="space-y-6">
                {chatHistory.length > 0 ? (
                  ...
                  <div className="bg-surface-container-lowest rounded-xl p-6 shadow-sm text-center py-12">
                    <span className="material-symbols-outlined text-4xl text-on-surface-variant/30 mb-4">chat_bubble</span>
                    <p className="text-on-surface-variant">No chat history yet. Start a triage session to see your history.</p>
                    <button
                      onClick={() => navigate('/chat')}
                      className="mt-4 bg-primary text-white px-6 py-2 rounded-lg font-bold hover:bg-primary-container transition-all"
                    >
                      Start Triage
                    </button>
                  </div>
                ...
                <div className="bg-surface-container-lowest rounded-xl p-6 shadow-[0_32px_32px_-4px_rgba(27,28,27,0.06)] border-l-4 border-outline-variant/30 transition-transform hover:scale-[1.01] cursor-pointer opacity-60">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <p className="text-xs font-bold text-on-surface-variant/50 uppercase tracking-widest mb-1">Sample Session</p>
            ...
            <div className="bg-surface-container-low rounded-xl p-6 shadow-[0_32px_32px_-4px_rgba(27,28,27,0.06)]">
              ...
              <div className="space-y-4">
                <div className="group cursor-pointer" onClick={() => navigate('/clinics')}>
                  <div className="aspect-video w-full rounded-lg overflow-hidden mb-3 bg-gradient-to-br from-secondary/20 to-primary/10 flex items-center justify-center">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-secondary/10 text-secondary text-[10px] font-bold uppercase px-2 py-0.5 rounded">
                      Sliding Scale
                    </span>
                    <span className="bg-secondary/10 text-secondary text-[10px] font-bold uppercase px-2 py-0.5 rounded">
                      Walk-in
                ...
                <div className="bg-outline-variant/20 h-[1px] w-full my-6" />

                <div className="group cursor-pointer" onClick={() => navigate('/clinics')}>
                  <div className="aspect-video w-full rounded-lg overflow-hidden mb-3 bg-gradient-to-br from-primary/10 to-tertiary/10 flex items-center justify-center">
